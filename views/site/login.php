...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <?= Html::a('<i class="fa fa-key"></i>ADMIN', ['/site/login'], ['class'=>'btn btn-app bg-green']) ?>
        ...
        <div class="row">
            ...
            <!-- /.col -->
            <div class="col-xs-12">
                <?= Html::submitButton('LOGIN ADMINISTRATOR', ['class' => 'btn bg-green btn-block btn-flat', 'name' => 'login-button']) ?>
            </div>
            <!-- /.col -->
        </div>
